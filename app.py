...
def gen_frames():
    ...
    faceProto = os.path.join(current_dir, "opencv_face_detector.pbtxt")
    faceModel = os.path.join(current_dir, "opencv_face_detector_uint8.pb")
    ageProto = os.path.join(current_dir, "age_deploy.prototxt")
    ageModel = os.path.join(current_dir,"age_net.caffemodel")
    genderProto = os.path.join(current_dir,"gender_deploy.prototxt")
    genderModel = os.path.join(current_dir,"gender_net.caffemodel")
